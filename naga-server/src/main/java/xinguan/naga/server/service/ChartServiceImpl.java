...
import xinguan.naga.entity.visual.Location;
import xinguan.naga.repository.visual.ChartInfoRepository;
...
public class ChartServiceImpl implements ChartService {
  ...
  @Resource ChartInfoRepository chartInfoRepository;
  ...
  private ChartInfo generateChartInfo(ChartInfoVo chartInfoVo) throws IOException {
    ...
    chartInfo.setCreateTime(DateUtil.toIntSecond(new Date()));
    chartInfo.setTrash(false);
    ...
    String chartSpecific =
        JsonUtil.toJson(
            generateChartSpecific(chartInfoVo.getChartSpecific(), chartInfoVo.getChartType()));
  ...
  private Object generateChartSpecific(Map<String, Object> chartSpecific, ChartType chartType) {
    ...
    switch (chartType) {
      case histogram:
        ...
        barChartSetting.setShowLine(
            chartSpecific.getOrDefault("showLine", "").toString().split(","));
        barChartSetting.setXAxisType(
            Strings.emptyToNull(chartSpecific.getOrDefault("xAxisType", "").toString()));
        barChartSetting.setYAxisName(
            ObjectUtil.isNull(chartSpecific.get("yAxisName"))
                ? null
                : chartSpecific.get("yAxisName").toString().split(","));
        barChartSetting.setYAxisType(
            ObjectUtil.isNull(chartSpecific.get("yAxisType"))
                ? null
                : chartSpecific.get("yAxisType").toString().split(","));
      ...
      case pie:
        ...
        pieChartSetting.setHoverAnimation(
            Boolean.parseBoolean(chartSpecific.getOrDefault("hoverAnimation", "true").toString()));
        pieChartSetting.setLimitShowNum(
            Integer.parseInt(chartSpecific.getOrDefault("limitShowNum", "8").toString()));
      ...
      case line:
        ...
        lineChartSetting.setArea(
            Boolean.parseBoolean(chartSpecific.getOrDefault("area", "false").toString()));
        lineChartSetting.setXAxisType(
            Strings.emptyToNull(chartSpecific.getOrDefault("xAxisType", "").toString()));
        lineChartSetting.setYAxisName(
            ObjectUtil.isNull(chartSpecific.get("yAxisName"))
                ? null
                : chartSpecific.get("yAxisName").toString().split(","));
        lineChartSetting.setYAxisType(
            ObjectUtil.isNull(chartSpecific.get("yAxisType"))
                ? null
                : chartSpecific.get("yAxisType").toString().split(","));
  ...
  @Override
  public ChartSpecific convertChartSpecific(String chartSpecific, ChartType chartType)
      throws IOException {
    switch (chartType) {
      case line:
