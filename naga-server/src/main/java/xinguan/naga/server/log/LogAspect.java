package xinguan.naga.server.log;
...
public class LogAspect {
  private final String operationLogPoint = "@annotation(xinguan.naga.server.log.OperationRecord)";
  ...
  public void recordOperation(JoinPoint joinPoint) throws Throwable {
    ...
    operationLog.setTrash(false);
    operationLog.setCreateTime(DateUtil.toIntSecond(new Date()));
