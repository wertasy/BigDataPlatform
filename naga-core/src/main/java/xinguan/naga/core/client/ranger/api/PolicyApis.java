...
import feign.Param;
import xinguan.naga.core.client.ranger.model.Policy;
...
public class PolicyApis {
  ...
  public Policy getPolicyByName(
      @Param("serviceName") final String serviceName, @Param("policyName") final String policyName)
