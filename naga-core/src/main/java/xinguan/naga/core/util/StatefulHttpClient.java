package xinguan.naga.core.util;
...
public class StatefulHttpClient {
  ...
  public StatefulHttpClient(int sessionTimeOut, int requestTimeOut, HttpHost proxy) {
    ...
    RequestConfig.Builder requestConfigBuilder =
        RequestConfig.custom()
            .setConnectTimeout(this.requestTimeOut * 1000)
            .setSocketTimeout(this.requestTimeOut * 1000);
    if (proxy != null) {
      requestConfigBuilder.setProxy(proxy);
    }
    httpclient =
        HttpClientBuilder.create().setDefaultRequestConfig(requestConfigBuilder.build()).build();
  }
  ...
  public <T> T get(
      Class<T> clazz, String url, Map<String, String> queryParam, Map<String, String> headers)
      throws IOException {
  ...
  public void download(
      String url, Map<String, String> queryParam, Map<String, String> headers, String filePath)
      throws IOException {
